  ...
  return (
    <div className="max-w-[1320px] mx-auto mt-20 font-primary ">
      <section className="bg-white dark:bg-gray-900 ">
        <div className="h-[32rem] bg-gray-100 rounded-lg dark:bg-gray-800">
          <div className="container px-6 py-10 mx-auto">
            ...
            <p className="max-w-3xl mx-auto text-center text-gray-500 dark:text-gray-300">
              ...
              knowledge of a wide range of vehicles, we offer personalized
              assistance to help you find the perfect car that suits your needs
              and budget. Our team ensures a hassle-free buying experience,
              offering expert guidance, competitive pricing, and post-sale
              support. Whether you're looking for a new or used vehicle, our
              experienced staff is here to make your car-buying journey smooth
              and enjoyable. Your satisfaction is our priority!
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
            ...
            >
              <img
                ...
                src="https://i.ibb.co.com/C0Nfx99/344551767-973588020327529-6772320673113315707-n.jpg"
                alt=""
              />
              ...
              <p className="mt-2 text-gray-500 capitalize dark:text-gray-300">
                MERN Developer | AutoLux Developer
              </p>
